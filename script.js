...
document.querySelectorAll('a[href*="wa.me/919262318410"]').forEach(link=>{
  link.href=`https://wa.me/919262318410?text=${encodeURIComponent(whatsappMessage)}`;
...
const heroWhatsAppUrl=`https://wa.me/919262318410?text=${encodeURIComponent(whatsappMessage)}`;
